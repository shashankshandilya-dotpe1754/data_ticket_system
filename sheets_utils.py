...
# ==========================================================
# Transfer — creates a brand-new ticket row (new Ticket ID),
# copying the original description across, linked back to the
# original via "Parent Ticket ID" / "Previous Ticket ID".
# ==========================================================
